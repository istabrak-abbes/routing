...
class TSPDataset(Dataset):
    ...
    def __init__(self, size=50, num_samples=1e6, seed=None):
        ...
        [[[5, 0.7127, 0.6752, 0.1566, 0.5825, 0.3738],
        [0.1472, 0.3260, 0.0369, 0.6027, 0.0896, 0.4393]]])

        
        self.dynamic = torch.zeros(1, 1, 6)
        self.num_nodes = 6
        self.size = 1
...
def reward(static, tour_indices):
    ...
    print("tsptourlen", tour_len)
    return tour_len.sum(1).detach()
    print("tsp",tour_len.sum(1).detach())
